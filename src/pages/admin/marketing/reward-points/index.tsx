...
const RewardPoints = () => {
  ...
  return (
    <Flex direction="column" gap={4}>
      ...
      <Card title="Ballar to'plang" contentClassName="p-0">
      ...
      <Card title="Ballarni konvertatsiya kursi" gap={4}>
        <Flex align="center" gap={3}>
      ...
      <Card title="Keshbekni ishlatish qoidalari">
        <Flex direction="column">
          <div className="grid w-full grid-cols-3 gap-4">
            <Flex direction="column">
              <Input label="Minimal foydalanish (ball)" name="minUsage" type="number" defaultValue="0" />
            </Flex>
            <Flex direction="column">
              <Input label="Buyurtma summasidan maksimum (%)" name="maxPercent" type="number" defaultValue="100" />
            </Flex>
            <Flex direction="column">
              <Input label="Kiritish qadami" name="step" type="number" defaultValue="1" />
            </Flex>
          </div>
          <Flex justify="end">
            <SaveButton />
