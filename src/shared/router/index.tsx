...
const appDomainRouter = (): RouteObject[] => [
  {
    path: ROUTES.ROOT,
        ...
        children: [
          {
            ...
            children: [
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    Component: lazy(
                      () => import("@pages/admin/orders/settings")
                    ),
                  },
                ],
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    Component: lazy(
                      () => import("@pages/admin/catalog/inventory")
                    ),
                  },
                  {
                  ...
                  },
                  {
                    ...
                    Component: lazy(
                      () => import("@pages/admin/catalog/import")
                    ),
                  },
                  {
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    Component: lazy(
                      () => import("@pages/admin/marketing/reviews")
                    ),
                  },
                  {
              ...
              },
              {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    Component: lazy(
                      () => import("@pages/admin/analytics/sales")
                    ),
                  },
                  {
                    path: ROUTES.ANALYTICS_HITS,
                    Component: lazy(
                      () => import("@pages/admin/analytics/hits")
                    ),
                  },
                  {
                  ...
                  },
                  {
                    ...
                    Component: lazy(
                      () => import("@pages/admin/analytics/cart")
                    ),
                  },
                ],
              },
              ...
              {
                path: ROUTES.PRICING,
                Component: lazy(() => import("@pages/admin/pricing")),
              },
            ],
          },
        ],
